        ...
        //Load the directions module.
         Microsoft.Maps.loadModule('Microsoft.Maps.Directions', function () {
            ...
            if (typeof from == "string"){
                ...
                start = new Microsoft.Maps.Directions.Waypoint({address:from});
            } else {
                console.log("latlon mode");
            ...
            if (typeof to == "string"){
                console.log("string mode");
                end = new Microsoft.Maps.Directions.Waypoint({address:to});
            } else {
                console.log("latlon mode");
                end = new Microsoft.Maps.Directions.Waypoint({
                    location: {
                        latitude: to[0],
                        longitude: to[1]
                    }
